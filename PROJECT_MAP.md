...
| **স্মার্ট অটো-লেআউট ইঞ্জিন** | `২-কলাম স্কুল প্রশ্নপত্র`, `উদ্দীপক বক্স`, ডানপাশে নম্বর `[৪]`, নোটিশ ও দলিলের স্বয়ংক্রিয় ওয়ার্ড ২০০৩ (.doc) ও আপডেট ওয়ার্ড (.docx) জেনারেটর | `js/layout-engine/`<br>`index.html`<br>`js/ai-ocr-engine.js` | জেমিনি ও টেক্সট কনভার্টার থেকে ফাইলের ধরন অনুযায়ী ১-ক্লিকে সরাসরি লেআউটসহ প্রিন্ট-রেডি ফাইল ডাউনলোড |
| **মাস্টার লেআউট স্পেসিফিকেশন** | `লেআউট নিয়মাবলী রেজিস্ট্রি`, হ্যাঙ্গিং ইনডেন্ট, টেবিল রুলস, রিগ্রেশন টেস্ট স্যুট ও অপরিবর্তনীয় চুক্তি | `LAYOUT_SPECIFICATION.md`<br>`scratch/regression_layout_suite.js` | প্রতিটি ফাইলের লেআউট রুল সংরক্ষণ ও পূর্বের নিয়ম অক্ষুণ্ণ রাখার স্বয়ংক্রিয় রিগ্রেশন টেস্ট গেটওয়ে |
...
| **এআই ওসিআর ইঞ্জিন** | `js/ai-ocr-engine.js` | Zero-Token প্রাক-যাচাই, ফাস্ট ফেইলওভার ও জেমিনি ৩.৫ ফ্ল্যাশ কোয়ালিটি-ফার্স্ট OCR রূপান্তর |
